...
export default function Works() {
  ...
  return (
    <>
      ...
      <div className="relative h-[46rem] max-w-7xl mx-auto px-6 sm:px-8 md:px-16 py-16 text-neutral-200"
        ref={card1Ref}>
          {/* Top divider */}
      ...
      <div className="relative h-[46rem] -mt-40 max-w-7xl mx-auto px-6 sm:px-8 md:px-16 py-16 text-neutral-200"
        ref={card3Ref}>

  ...
  return (
    <>
      <section id="work" className="min-h-screen max-w-9xl mx-auto bg-[#0a0a0a]">
        <div className="lg:max-w-7xl max-w-104 mx-auto mt-24  text-white">
          <h1 className="text-[3.5rem] sm:text-[5rem] lg:text-[6.5rem] font-extrabold tracking-tight ">WHAT I DO /</h1>
        </div>

        <div className="text-white max-w-7xl mx-auto mt-24 grid grid-cols-1 md:grid-cols-6 gap-6 px-4">
          {/* Left side spacing (hidden on mobile, visible on desktop) */}
          <div className="hidden md:block md:col-span-3"></div>

          {/* Services heading */}
          <div className="md:col-span-1 flex flex-col">
            <h1 className="font-light text-lg sm:text-xl md:text-2xl">(SERVICES)</h1>
          </div>
      ...
      <div className="relative h-184 max-w-7xl mx-auto px-6 sm:px-8 md:px-16 py-16 text-neutral-200"
        ref={card1Ref}>
          {/* Top divider */}
      ...
      <div className="relative h-184 -mt-40 max-w-7xl mx-auto px-6 sm:px-8 md:px-16 py-16 text-neutral-200"
        ref={card3Ref}>
